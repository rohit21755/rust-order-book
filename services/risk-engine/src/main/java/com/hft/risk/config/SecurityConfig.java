...
public class SecurityConfig {
    ...
    @Bean
    public JwtTokenValidator jwtTokenValidator(RiskProperties props) {
    ...
    public SecurityWebFilterChain securityFilterChain(ServerHttpSecurity http,
        ...
        http
                ...
                .authorizeExchange(ex -> ex
                        ...
                        .pathMatchers("/api/risk/config").hasAnyRole("ADMIN", "TRADER", "READ_ONLY")
                        .pathMatchers("PUT", "/api/risk/config").hasRole("ADMIN")
                        .pathMatchers("/api/risk/users/*/halt", "/api/risk/users/*/resume").hasRole("ADMIN")
                        .pathMatchers("/api/risk/users/**").hasAnyRole("ADMIN", "TRADER")
